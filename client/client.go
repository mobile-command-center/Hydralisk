...
type Client struct {
	...
	EmailCheck              string `json:"emailCheck,omitempty" form:"emailCheck,omitempty"`
	...
	SpBankAccount           string `json:"g_sp_bank_account" form:"g_sp_bank_account"`   //사은품(현금) 지급은행 계좌번호
	...
	Agree                   string `json:"w_agree" form:"w_agree"`                       //가입약관(동의)
